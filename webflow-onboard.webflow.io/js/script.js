...
! function(t) {
    ...
    n(131), n(133), n(134), n(69), n(136), n(332), n(333), n(334), n(335), t.exports = n(340)
}, function(t, e, n) {
    "use strict";
    var r = n(6);
    r.define("brand", t.exports = function(t) {
        ...
        return n.ready = function() {
            ...
            /\.webflow\.io$/i.test(p) && c.hostname !== p && (u = !0), u && !s && (e = e || (n = t(), r = t("<img>").attr("alt", "").css({
                marginRight: "8px",
                width: "16px"
            }), a = t(""), n.append(r, a), n[0]), d(), setTimeout(d, 500), t(i).off(f, l).on(f, l))
        }, n
    })
}, function(t, e, n) {
    "use strict";
    ...
    Object.defineProperty(e, "__esModule", {
                    ...
                    switch (u) {
                        case it:
                            var s = r.config,
                                ...
                                h = n.widthValue,
                                E = n.heightValue;
                            void 0 !== h && (d === W && (d = "px"), Rt(t, L, o), a(t, L, h + d)), void 0 !== E && (v === W && (v = "px"), Rt(t, M, o), a(t, M, E + v));
                            break;
                        case rt:
                            ! function(t, e, n, r) {
        ...
        if (o === it) {
            var a = e.config;
            a.widthUnit === W && r(t, L, ""), a.heightUnit === W && r(t, M, "")
        }
        i(t, U) && Mt({
            effect: Nt,
            actionTypeId: o,
    ...
    var f = s(n(269)),
        ...
        dt = Object.freeze((i = {}, (0, c.default)(i, _.TRANSFORM_PREFIXED, I), (0, c.default)(i, P, m), (0, c.default)(i, N, N), (0, c.default)(i, C, C), (0, c.default)(i, L, L), (0, c.default)(i, M, M), i)),
        pt = {},
        vt = 1;
    var ht = 1;
    var Et = function(t, e) {
    ...
    var r = n(3),
        ...
        b = function(t, e) {
            ...
            if (r && i) {
                ...
                if (w < 0) return t;
                var R = v(Math.min(Math.max(0, w / T), 1)),
                    N = h(m, R, _),
                    C = {},
                    L = null;
    ...
    var c, s, f, l = u(n(30)),
        ...
        gt = (r = {}, (0, o.default)(r, x, vt()), (0, o.default)(r, R, ht()), (0, o.default)(r, S, vt()), (0, o.default)(r, A, ht()), (0, o.default)(r, M, vt(!1)), (0, o.default)(r, L, ht(!1)), (0, o.default)(r, N, vt()), (0, o.default)(r, C, ht()), (0, o.default)(r, U, {
    ...
    r.define("slider", t.exports = function(t, e) {
        ...
        function T(e, n) {
            ...
            i.el.off(v), i.left.off(v), i.right.off(v), i.nav.off(v), b(i), u ? (i.el.on("setting" + v, C(i)), N(i), i.hasTimer = !1) : (i.el.on("swipe" + v, C(i)), i.left.on("click" + v, S(i)), i.right.on("click" + v, x(i)), i.left.on("keydown" + v, A(i, S)), i.right.on("keydown" + v, A(i, x)), i.nav.on("keydown" + v, "> div", C(i)), i.config.autoplay && !i.hasTimer && (i.hasTimer = !0, i.timerCount = 1, R(i)), i.el.on("mouseenter" + v, w(i, !0, "mouse")), i.el.on("focusin" + v, w(i, !0, "keyboard")), i.el.on("mouseleave" + v, w(i, !1, "mouse")), i.el.on("focusout" + v, w(i, !1, "keyboard"))), i.nav.on("click" + v, "> div", C(i)), p || i.mask.contents().filter(function() {
        ...
        function C(n) {
            return function(i, a) {
                ...
                if (u && "setting" === i.type) {
                    ...
                    if (b(n), D(n), null == a.select) return;
                    ! function(n, r) {
                        var i = null;
                        r === n.slides.length && (y(), D(n)), e.each(n.anchors, function(e, n) {
...
Webflow.require('ix2').init({
    "events": {
        "e-26": {
            ...
            "target": {
                "selector": ".slide",
                "originalId": "5e4f70d9dfde535ce7edeaf0|f5553279-b5c4-8798-1876-9199a972d9dd",
                "appliesTo": "CLASS"
            },
            "targets": [{
                "selector": ".slide",
        ...
        "e-69": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "5e4f70d9dfde535ce7edeaf0|d566a556-93b8-1f1d-ff0f-f97aff15c00c",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-73": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "5e4f70d9dfde535ce7edeaf0|bd4b95dd-680e-12ed-c28b-253c073d337d",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-75": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "5e4f70d9dfde535ce7edeaf0|34cb84a3-bc68-1b9e-4588-d7b6b457eaa1",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-77": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "5e4f70d9dfde535ce7edeaf0|34cb84a3-bc68-1b9e-4588-d7b6b457eaac",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-79": {
            ...
            "target": {
                ...
                "originalId": "5e4f70d9dfde535ce7edeaf0|28571e59-5f5a-86ef-5a1f-43de69f7c508",
                "appliesTo": "CLASS"
            },
            "targets": [{
                "selector": ".slider-left",
    ...
    "actionLists": {
                ...
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            ...
                            "selector": ".logo",
                            "selectorGuids": ["92489f71-79b4-3e9b-cb93-86df805e08fd"]
                        },
                        "yValue": 25,
                        "xUnit": "PX",
                        "yUnit": "PX",
                    ...
                    "config": {
                        ...
                        "target": {
                            ...
                            "selectorGuids": ["4392a81f-56af-d2c5-fa22-13d4cd3f4354"]
                        },
                        "yValue": 25,
                        "xUnit": "PX",
                        "yUnit": "PX",
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "CHILDREN",
                            "selector": ".form-wrap",
                            "selectorGuids": ["4392a81f-56af-d2c5-fa22-13d4cd3f4368"]
                        },
                        "yValue": 25,
                        "xUnit": "PX",
                        "yUnit": "PX",
                    ...
                    "config": {
                        ...
                        "target": {
                            ...
                            "selectorGuids": ["300ba4da-cad6-f0ae-90b4-0f52d521f784"]
                        },
                        "yValue": 25,
                        "xUnit": "PX",
                        "yUnit": "PX",
                    ...
                    "config": {
                        ...
                        "target": {
                            ...
                            "selectorGuids": ["c423470e-8552-745e-4941-f21e88f22437"]
                        },
                        "yValue": 25,
                        "xUnit": "PX",
                        "yUnit": "PX",
                    ...
                    "config": {
                        ...
                        "target": {
                            ...
                            "selectorGuids": ["17fd1aed-033f-e3f2-97aa-dd44d1ea1a3e"]
                        },
                        "value": 0,
                        "unit": ""
                    }
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "CHILDREN",
                            "selector": ".quote-wrap",
                            "selectorGuids": ["2ace41f6-d3e1-b2a4-6db8-8b51d13d993a"]
                        },
                        "yValue": 25,
                        "xUnit": "PX",
                        "yUnit": "PX",
                ...
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            ...
                            "selector": ".checkbox-field.checkbox-base",
                            "selectorGuids": ["4392a81f-56af-d2c5-fa22-13d4cd3f4360", "4392a81f-56af-d2c5-fa22-13d4cd3f436a"]
                        },
                        "globalSwatchId": "",
                        "rValue": 54,
                        "bValue": 126,
        ...
        "a-9": {
                ...
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "CHILDREN",
                            "selector": ".arrow",
                            "selectorGuids": ["4392a81f-56af-d2c5-fa22-13d4cd3f4364"]
                        },
                        "xValue": -4,
                        "xUnit": "PX",
                        "yUnit": "PX",
            ...
            "useFirstGroupAsInitialState": false,
            "createdOn": 1582680401268
        },
        "a-10": {
            "id": "a-10",
            "title": "(HOVER) Back Arrow (OUT)",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-10-n",
                    "actionTypeId": "TRANSFORM_MOVE",
